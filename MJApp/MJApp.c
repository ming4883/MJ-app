...
void drawBackground(void)
{
	...
	static const CrVec4 c[] = {
		...
		{0x59 / 255.f,  0xc3 / 255.f, 0xff / 255.f, 1.0f}, // upper-left
		{0x64 / 255.f,  0xcd / 255.f, 0xf2 / 255.f, 1.0f}, // upper-right
	};
/*
	static const CrVec4 c[] = {
		{0xcd / 255.f, 0xcd / 255.f, 0xff / 255.f, 1.0f}, // lower-left
		{0xf5 / 255.f, 0xb9 / 255.f, 0xeb / 255.f, 1.0f}, // lower-right
		{0xa8 / 255.f, 0x80 / 255.f, 0xa2 / 255.f, 1.0f}, // upper-left
		{0x8f / 255.f, 0x8f / 255.f, 0xb3 / 255.f, 1.0f}, // upper-right
